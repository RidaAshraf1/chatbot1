/*****************************************************************************************
Program to order food using chatbot
input file : config.txt
inputs : choice and menus
output  : order confirmation, support details
author : Rida ,Akshara,Prashanthi, Thulasi, Arul Nithika
date  : 2
*********************************************************************************************/
...
out put : string name in global array soption[]
